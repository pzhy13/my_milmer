...
# --- 4. 设置日志记录 (Logging) ---
def setup_logging(log_file='train_fast.log'): # 新的日志文件
...
# --- 7. 主函数 (修改为 80/20 单次运行) ---
def main():
    setup_logging('train_fast.log') # 日志名已更新
    ...
    # --- 关键修改：80/20 划分 ---
    logging.info("正在创建 80/20 训练/验证集...")
    total_size = len(full_dataset)
    val_size = int(total_size * 0.2) # 20% 验证集
    train_size = total_size - val_size # 80% 训练集
    ...
    model_save_path = './best_model_fast_run.pth'
